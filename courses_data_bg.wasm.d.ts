...
export const __wbg_searchengine_free: (a: number, b: number) => void;
export const searchengine_new: (a: number, b: number) => number;
export const searchengine_search: (a: number, b: number, c: number) => [number, number];
export const searchengine_from_include_bytes: () => any;
